...
Aplicar los conceptos aprendidos en la Semana 01 para diseñar e implementar una solución
...
- [ ] Entorno Docker funcionando (`docker compose up`)
- [ ] Base de datos creada con al menos 2 tablas
- [ ] Captura de pantalla desde pgAdmin/DBeaver
...
- [Semana 01 — Teoría](../1-teoria/)
- [Semana 01 — Prácticas](../2-practicas/)
