# Proyecto Semana 06 — Modelo relacional completo de la red social (semana 05) en DBML
...
Aplicar los conceptos aprendidos en la Semana 06 para diseñar e implementar una solución
...
- [ ] Modelo relacional en DBML (dbdiagram.io)
- [ ] Script DDL preliminar con `CREATE TABLE` básicos
- [ ] Tabla de decisiones de transformación
...
- [Semana 06 — Teoría](../1-teoria/)
- [Semana 06 — Prácticas](../2-practicas/)
