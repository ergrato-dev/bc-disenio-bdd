# Proyecto Semana 07 — Normalizar hasta 2FN el esquema de la red social (semana 06)
...
Aplicar los conceptos aprendidos en la Semana 07 para diseñar e implementar una solución
...
- [ ] Scripts `CREATE TABLE` antes y después de normalizar
- [ ] Justificación escrita de cada decisión
