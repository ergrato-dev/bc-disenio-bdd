# Proyecto Semana 11 — Estrategia de indexación para el sistema de gestión de proyectos con benchmark
...
Aplicar los conceptos aprendidos en la Semana 11 para diseñar e implementar una solución
